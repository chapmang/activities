...
Encore
     ...
     */
    .addEntry('walk', './src/Presentation/Web/Pub/assets/js/walk.js')
    .addEntry('activity', './src/Presentation/Web/Pub/assets/js/activity.js')
    .addEntry('collection', './src/Presentation/Web/Pub/assets/js/collection.js')
