 ...
 */
final class Version20200607113057 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT IDENTITY NOT NULL, maproyalty INT, name NVARCHAR(190) NOT NULL, start_grid_ref NVARCHAR(45), latitude NUMERIC(10, 8), longitude NUMERIC(11, 8), point GEOGRAPHY, short_description VARCHAR(MAX), description VARCHAR(MAX), searchable_description VARCHAR(MAX), status INT NOT NULL, online_friendly BIT NOT NULL, slug NVARCHAR(190), created_date DATETIME2(6) NOT NULL, modified_date DATETIME2(6) NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, type NVARCHAR(45) NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE cycle (id INT NOT NULL, PRIMARY KEY (id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cycle DROP CONSTRAINT FK_B086D193BF396750');
