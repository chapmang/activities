<?php
namespace App\Domain\DataTypes\Spatial\DBAL\Types;

use App\Domain\DataTypes\Spatial\DBAL\Platform\PlatformInterface;
use App\Domain\DataTypes\Spatial\Exception\InvalidValueException;
use App\Domain\DataTypes\Spatial\Exception\UnsupportedPlatformException;
...
public const PLATFORM_MSSQL = 'SqlServer';
...
$class = sprintf('App\Domain\DataTypes\Spatial\DBAL\Platform\%s', constant($const));
