...
/**
 * Class WordExportStrategy
 * @package App\Application\Export
 */
final class WordExportStrategy implements ExportStrategyInterface
{
    private $key = 'docx';
     ...
     */
    public function export($activity, $group): Response
    {
    ...
    private function collectProperties($activity, $filteredProperties): array
    {
        ...
        foreach ($filteredProperties as $property) {
            ...
            if ($property->getValue($activity) instanceof PersistentCollection) {
