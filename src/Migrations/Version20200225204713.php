 ...
 */
final class Version20200225204713 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE direction (id INT AUTO_INCREMENT NOT NULL, activity INT NOT NULL, position INT NOT NULL, direction LONGTEXT NOT NULL, created_date DATETIME NOT NULL, modified_date DATETIME NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, INDEX IDX_3E4AD1B3AC74095A (activity), INDEX IDX_3E4AD1B37AF16D89 (createdUser), INDEX IDX_3E4AD1B3160C1387 (modifiedUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE collection_contents (id INT AUTO_INCREMENT NOT NULL, collection INT NOT NULL, activity INT NOT NULL, position INT NOT NULL, INDEX IDX_457ADF47FC4D6532 (collection), INDEX IDX_457ADF47AC74095A (activity), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(190) NOT NULL, created_date DATETIME NOT NULL, modified_date DATETIME NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, UNIQUE INDEX UNIQ_389B7835E237E06 (name), INDEX IDX_389B7837AF16D89 (createdUser), INDEX IDX_389B783160C1387 (modifiedUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, first_name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE map_royalty (id INT AUTO_INCREMENT NOT NULL, activity INT NOT NULL, width DOUBLE PRECISION DEFAULT NULL, height DOUBLE PRECISION DEFAULT NULL, map_scale INT DEFAULT NULL, source_scale INT DEFAULT NULL, sea_area INT DEFAULT NULL, created_date DATETIME NOT NULL, modified_date DATETIME NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, INDEX IDX_640D0E59AC74095A (activity), INDEX IDX_640D0E597AF16D89 (createdUser), INDEX IDX_640D0E59160C1387 (modifiedUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_flag (id INT AUTO_INCREMENT NOT NULL, activity INT NOT NULL, description LONGTEXT DEFAULT NULL, created_date DATETIME NOT NULL, modified_date DATETIME NOT NULL, flagType INT NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, INDEX IDX_AB75A753AC74095A (activity), INDEX IDX_AB75A753DAA2006D (flagType), INDEX IDX_AB75A7537AF16D89 (createdUser), INDEX IDX_AB75A753160C1387 (modifiedUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE collection (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(190) NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(45) DEFAULT \'public\' NOT NULL, slug VARCHAR(255) NOT NULL, created_date DATETIME NOT NULL, modified_date DATETIME NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, UNIQUE INDEX UNIQ_FC4D65325E237E06 (name), INDEX IDX_FC4D65327AF16D89 (createdUser), INDEX IDX_FC4D6532160C1387 (modifiedUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE route_point (id INT AUTO_INCREMENT NOT NULL, activity INT NOT NULL, direction INT DEFAULT NULL, route_order INT NOT NULL, latitude NUMERIC(10, 8) NOT NULL, longitude NUMERIC(11, 8) NOT NULL, created_date DATETIME NOT NULL, modified_date DATETIME NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, INDEX IDX_2ADAC18AAC74095A (activity), UNIQUE INDEX UNIQ_2ADAC18A3E4AD1B3 (direction), INDEX IDX_2ADAC18A7AF16D89 (createdUser), INDEX IDX_2ADAC18A160C1387 (modifiedUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE admin_notes (id INT AUTO_INCREMENT NOT NULL, collection INT DEFAULT NULL, activity INT DEFAULT NULL, note VARCHAR(255) NOT NULL, created_date DATETIME NOT NULL, modified_date DATETIME NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, INDEX IDX_A1315D76FC4D6532 (collection), INDEX IDX_A1315D76AC74095A (activity), INDEX IDX_A1315D767AF16D89 (createdUser), INDEX IDX_A1315D76160C1387 (modifiedUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, activity INT NOT NULL, name VARCHAR(190) NOT NULL, type VARCHAR(45) NOT NULL, created_date DATETIME NOT NULL, modified_date DATETIME NOT NULL, createdUser INT NOT NULL, modifiedUser INT NOT NULL, INDEX IDX_C53D045FAC74095A (activity), INDEX IDX_C53D045F7AF16D89 (createdUser), INDEX IDX_C53D045F160C1387 (modifiedUser), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE direction ADD CONSTRAINT FK_3E4AD1B3AC74095A FOREIGN KEY (activity) REFERENCES activity (id)');
        $this->addSql('ALTER TABLE direction ADD CONSTRAINT FK_3E4AD1B37AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE direction ADD CONSTRAINT FK_3E4AD1B3160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE tag ADD CONSTRAINT FK_389B7837AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE tag ADD CONSTRAINT FK_389B783160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095A7AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095A160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE map_royalty ADD CONSTRAINT FK_640D0E597AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE map_royalty ADD CONSTRAINT FK_640D0E59160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE user_flag ADD CONSTRAINT FK_AB75A7537AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE user_flag ADD CONSTRAINT FK_AB75A753160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE collection ADD CONSTRAINT FK_FC4D65327AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE collection ADD CONSTRAINT FK_FC4D6532160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE route_point ADD CONSTRAINT FK_2ADAC18A7AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE route_point ADD CONSTRAINT FK_2ADAC18A160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE admin_notes ADD CONSTRAINT FK_A1315D767AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE admin_notes ADD CONSTRAINT FK_A1315D76160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045FAC74095A FOREIGN KEY (activity) REFERENCES activity (id)');
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F7AF16D89 FOREIGN KEY (createdUser) REFERENCES user (id)');
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F160C1387 FOREIGN KEY (modifiedUser) REFERENCES user (id)');
    }
